...
<body>
  ...
  <div class="banner">
        ...
        <div class="detail">
            ...
            <span><a href="home.php">home</a><i class="bx bxs-right-arrow-alt"></i>My Booking</span>
        </div>
    </div>
        ...
        <div class="box">
         ...
         <div class="detail">
            <div class="content">
                ...
                <div>
                    <p>total seat : <?=$fetch_booking['total_seat'] ?></p>
                    <p>seat no : <?=$fetch_booking['seat_details'] ?></p>
                </div>
            </div>
            <a href="rating.php?get_id=<?= $fetch_booking['id']; ?>" class="btn">Give rating</a>
         </div>
            </a>
